                ...
                <div class="row">
                    ...
                    <section>
                        ...
                        <article class="single-blog-item">
                            ...
                            <h3>
                                Overall: หลาย ๆ คนอาจจะไม่เคยกินละหมี่กึ่งรสนี้ แต่บอกเลยว่าคุณพลาดมากกกกกกกกกก
                                เส้นแบนนุ่มรู้สึกว่ากินแล้วไม่ค่อยดีดตีปาก5555555 รสชาติออกเปรี้ยวหวาน 
                                ยิ่งถ้าใส่น้ำจิ้มสุกี้ไปด้วยอร่อยมาก แม่งอร่อยแบบวัวตาย ควายล้ม กระทิงกระเด็น ไปตามเลยค่ะพส
                            </h3>
                                ...
                                <div class="item-info text-center">
                                    <div class="row">
                                        <div class="col-md-8 col-md-offset-2">
                                            <img class="img-responsive center-block" src="assets/image/4.png" alt="Item number 1" style="width:100%">
                                            <img class="img-responsive center-block" src="assets/image/2.4.jpg" alt="Item number 1" style="width:100%">
                                        </div>
                                    </div>
                        ...
                        <div class="author">
                            <h4>Written by <strong class="text-capitalize">ใครไม่กี้......สุกี้</strong></h4>
                            <h4>
                                หญิงสาวผู้ชอบกินสุกี้ ต้องได้กินอย่างน้อยวันละ 1 มื้อ ไม่งั่นจะลงแดงคล้าย ๆ คนติดบุหรี่555555555
                            </h4>
                        </div>
