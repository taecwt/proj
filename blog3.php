                    ...
                    <section>
                        ...
                        <article class="single-blog-item">
                            ...
                            <div>
                                ...
                                มาม่า, ต้มยำกุ้งน้ำข้น updated
                                <time>september 22,2018</time>
                            </div>

                            <h1>Review #3 มาม่าต้มยำกุ้งน้ำข้น</h1>
                            <h2>8/10</h2>
                            ...
                            <h3>
                                Flavor: ต้มยำกุ้งน้ำข้น
                            </h3>
                            
                            <h3>
                                Overall: เป็นเมนูที่บางคนอาจจะเคยหยิบผิด จากมาม่ารสต้มยำกุ้งธรรมดา เส้นนุ่ม น้ำพริกเผาเผ็ดแสบ 
                                ใครที่ไม่กินเผ็ดก็ใส่พริกเผาน้อยๆละกันไม่งั้นมีแสบคอ อร่อยดี แต่ไม่เท่ารสต้มยำกุ้งธรรมดา
                            </h3>
                                ...
                                <div class="item-info text-center">
                                    <div class="row">
                                        <div class="col-md-8 col-md-offset-2">
                                            <img class="img-responsive center-block" src="assets/image/3.png" alt="Item number 1" style="width:100%">
                                            <img class="img-responsive center-block" src="assets/image/2.3.jpg" alt="Item number 1" style="width:100%">
                                        </div>
                                    </div>
