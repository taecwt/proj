                    ...
                    <section>
                        ...
                        <article class="single-blog-item">
                            ...
                            <div>
                                ...
                                ไวไว, ดั้งเดิม updated
                                <time>july 30,2018</time>
                            </div>

                            <h1>Review #1 ไวไวรสดั้งเดิม</h1>
                            <h2>8/10</h2>
                            ...
                            <h3>
                                Overall: รสชาติที่หลาย ๆ คนคงคุ้นเคย ที่ทานกันตั้งแต่เด็ก ๆ อร่อยนุ่ม หอม แต่เสียดายน่าจะรสจัดกว่านี้ต้องใส่พริกไทย/พริกป่นเพิ่มเติมเพื่อที่จะอร่อยขึ้น
                            </h3>
                                ...
                                <div class="item-info text-center">
                                    <div class="row">
                                        <div class="col-md-8 col-md-offset-2">
                                            <img class="img-responsive center-block" src="assets/image/1.gif" alt="Item number 1" style="width:100%">
                                            <img class="img-responsive center-block" src="assets/image/2.1.jpg" alt="Item number 1" style="width:100%">
                                        </div>
                                    </div>
                        ...
                        <div class="author">
                            <h4>Written by <strong class="text-capitalize">คนรักไวไว</strong></h4>
                            <h4>
                                ประสบการณ์การกินบะหมี่กึ่งมา 10 ปี แต่ชอบไวไวมากสุด ได้รับรางวัล คนรักบะหมี่กึ่ง 2 ปีซ้อน 2016-2017
                            </h4>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <?php
	                                    ...
	                                    $sql = "SELECT * FROM comment WHERE noodle_no = 1";
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <?php if(empty($_SESSION["username"])){
                                                ...
                                                $sql = "SELECT * FROM comment WHERE noodle_no = 1 and username = '".$_SESSION["username"]."'";
	                                            $result = $conn->query($sql);
                                                if ($result->num_rows > 0) {
  	                                    // output data of each row
