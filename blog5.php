                ...
                <div class="row">
                    ...
                    <section>
                        ...
                        <article class="single-blog-item">
                            ...
                            <h3>
                                Overall: เส้นเหนียวนุ่ม  หอมนำมันเจียว รสหมูสับไม่ค่อยเข้มข้นเท่าไหร่ ต้องใส่น้ำน้อยๆถึงจะเข้มข้นขึ้นมา
                            </h3>
                                ...
                                <div class="item-info text-center">
                                    <div class="row">
                                        <div class="col-md-8 col-md-offset-2">
                                            <img class="img-responsive center-block" src="assets/image/5.png" alt="Item number 1" style="width:100%">
                                            <img class="img-responsive center-block" src="assets/image/2.5.jpg" alt="Item number 1" style="width:100%">
                                        </div>
                                    </div>
                        ...
                        <div class="author">
                            <h4>Written by <strong class="text-capitalize">ไวกว่าเดอะแฟลช</strong></h4>
                            <h4>
                                คนเราจะวิ่งเร็วที่สุดตอนวิ่งราว
                            </h4>
                        </div>
