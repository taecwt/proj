                    ...
                    <section>
                        ...
                        <article class="single-blog-item">
                            ...
                            <div>
                                ...
                                มาม่า, แกงเขียวหวานไก่ updated
                                <time>february 14,2020</time>
                            </div>

                            <h1>Review #9 มาม่าแกงเขียวหวานไก่</h1>
                            <h2>9/10</h2>
                            ...
                            <h3>
                                Flavor: แกงเขียวหวานไก่
                            </h3>
                            
                            <h3>
                                Overall: หอมกลิ่นแกงเขียวหวานมาก น้ำซุปนี่หวานมาก แต่ถ้าใครที่ไม่ชอบกลิ่นจะเลี่ยนมาก
                            </h3>
                                ...
                                <div class="item-info text-center">
                                    <div class="row">
                                        <div class="col-md-8 col-md-offset-2">
                                            <img class="img-responsive center-block" src="assets/image/9.png" alt="Item number 1" style="width:100%">
                                            <img class="img-responsive center-block" src="assets/image/2.9.jpg" alt="Item number 1" style="width:100%">
                                        </div>
                                    </div>
