                    ...
                    <section>
                        ...
                        <article class="single-blog-item">
                            ...
                            <div>
                                ...
                                มาม่า, เย็นตาโฟ updated
                                <time>november 6,2019</time>
                            </div>

                            <h1>Review #8 มาม่าเย็นตาโฟต้มยำหม้อไฟ</h1>
                            <h2>8/10</h2>
                            ...
                            <h3>
                                Overall: เส้นนุ่ม น้ำซุปเปรี้ยวมากก ใครชอบกินเปรี้ยวจะถูกปากมาก ไม่ค่อยได้กลิ่นต้มยำเท่าไหร่
                            </h3>
                                ...
                                <div class="item-info text-center">
                                    <div class="row">
                                        <div class="col-md-8 col-md-offset-2">
                                            <img class="img-responsive center-block" src="assets/image/8.png" alt="Item number 1" style="width:100%">
                                            <img class="img-responsive center-block" src="assets/image/2.8.jpg" alt="Item number 1" style="width:100%">
                                        </div>
                                    </div>
